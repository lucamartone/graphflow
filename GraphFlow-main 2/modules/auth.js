...
function updateMenuState(isLoggedIn, username = null) {
    ...
    if (isLoggedIn) {
        //nasconde il pulsante login e register e mostra il pulsante logout
        ...
        //nasconde il logout e mostra login e register
...
//controlla se l'utente è loggato con chiamata a check_auth.php aggiorna interfaccia di conseguenza, in base alla risposta data
