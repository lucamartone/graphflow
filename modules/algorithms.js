...
export function topSort(){
    ...
    /*
  dentro data di nodes data: { id, label, state:"UNEXPLORED" }
  aggiungi type: "none", in edd edge
...
export async function Dijkstra(start) {
    ...
    if (hasNegativeWeight()) {
      alert("Errore: il grafo contiene archi con peso negativo. Dijkstra non può essere eseguito.");
      return;
    }
